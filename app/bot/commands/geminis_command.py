...
async def geminis(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        prediccion = Horoscopo(Signos.GEMINIS.value)
        logger.info(f"Enviando predicción de: {Signos.GEMINIS.value}")
