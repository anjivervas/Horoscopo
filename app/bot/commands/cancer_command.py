...
async def cancer(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        prediccion = Horoscopo(Signos.CANCER.value)
        logger.info(f"Enviando predicción de: {Signos.CANCER.value}")
