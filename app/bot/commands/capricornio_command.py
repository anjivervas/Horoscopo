...
async def capricornio(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        prediccion = Horoscopo(Signos.CAPRICORNIO.value)
        logger.info(f"Enviando predicción de: {Signos.CAPRICORNIO.value}")
