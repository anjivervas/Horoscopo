...
async def aries(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        prediccion = Horoscopo(Signos.ARIES.value)
        logger.info(f"Enviando predicción de: {Signos.ARIES.value}")
