...
async def libra(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        prediccion = Horoscopo(Signos.LIBRA.value)
        logger.info(f"Enviando predicción de: {Signos.LIBRA.value}")
